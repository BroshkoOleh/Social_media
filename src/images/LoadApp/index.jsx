...
export default function LoadApp() {
    return (
        <>
          <div className={styles.loadAppContainer}>
          <svg xmlns:xlink="http://www.w3.org/1999/xlink"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="laptop-medium" data-supported-dps="24x24" fill="#666666" focusable="false" class="lazy-loaded" aria-busy="false">
